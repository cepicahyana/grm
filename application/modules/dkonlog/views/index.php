											...
											<div class="row">
												...
												<form class="form-horizontal" id="formSubmitImport" action="javascript:submitForm('formSubmitImport')" method="post" >
													<div class="form-group row">
														...
														<div class="col-md-9">
														<a class="sound" href="<?php echo base_url('dkonlog/getKonlogFile')?>">Download</a>
														</div>
													</div>
													<div class="form-group row">
...
{ 
	...
	$.post("<?php echo site_url("dkonlog/history"); ?>",function(data){
		$("#area_lod").html(data);
		unblock("area_lod");
	});	
}
...
{ 	
	...
	$("#area_import").show();
	$("#formSubmitImport").attr("url","<?php echo base_url()?>dkonlog/import_data");
}
