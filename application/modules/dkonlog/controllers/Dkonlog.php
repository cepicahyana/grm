...
class Dkonlog extends CI_Controller {
	...
	{
		$this->mdl->getKonlogFile();
	}
	function jsData(){
		$data['data']=$this->mdl->getLastKonlog();
	...
	function data_tables()
	{
		...
		foreach ($list as $dataDB) {
			...
			$row[] = "<span class='size' ><a href='#' onclick='detailKonlog(`".$dataDB->id."`)'>".$this->tanggal->hariLengkap($dataDB->tanggal,"-")."</a></span>";
