		...
		<div class="row">
			...
			<div class="col-md-5">
				...
				<div class="form-group">
					...
					<div>
						<input type="text" class="form-control" name="f[luas_wilayah]" placeholder="" required>
					</div>
				</div>
				<div class="form-group">
					<label class="black control-label">Batas Wilayah</label>
					<div>
						<textarea class="form-control" rows="3" name="f[batas_wilayah]" placeholder=""></textarea>
					</div>
				</div>
