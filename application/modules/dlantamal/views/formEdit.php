...
$luas_wilayah=isset($data->luas_wilayah)?($data->luas_wilayah):'';	
$batas_wilayah=isset($data->batas_wilayah)?($data->batas_wilayah):'';		
...
?>
			...
			<div class="col-md-5">
				...
				<div class="form-group">
					<label class="black control-label">Luas Wilayah</label>
					<div>
						<input type="text" class="form-control" name="f[luas_wilayah]" value="<?php echo $luas_wilayah ?>" placeholder="" required>
					</div>
				</div>
				<div class="form-group">
					<label class="black control-label">Batas Wilayah</label>
					<div>
						<textarea class="form-control" rows="3" name="f[batas_wilayah]" placeholder=""><?php echo $batas_wilayah ?></textarea>
					</div>
				</div>
