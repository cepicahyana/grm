		...
		?>
											...
											<!--	<div class="col-md-4 info-invoice">
												...
												<div class="col-md-4 info-invoice">
													...
													<h5 class="sub"><?php echo $data->t_nilai;?> % </h5>
													 <h5 class="sub"><b><?php echo $data->kondisi;?> </b></h5>
												</div>
											</div>
															...
															<table>
																	<thead>
																		<tr>
																			...
																			<th class="text-center" style="width:50%"><strong>Peralatan</strong></td> 
																			<th class="text-center" style="width:15%"><strong>Nilai</strong></th>
                                                                        ...
                                                                        if ($dataray) {
																				foreach ($dataray as $key=>$val) {
																					...
																					echo '
																							...
																							<td class="text-left">'.$val['peralatan'].'</td>
																...
																<!--		 
																		<tr>
																			<td class="text-right" colspan="3"><strong>Total Siap</strong></td>
																			<td class="text-right"><strong><?php echo $t_siap;?></strong></td>
																		</tr>
																		<tr>
																			<td class="text-right" colspan="3"><strong>Total tidak siap</strong></td>
